...
public class Search extends java.util.Vector {
    ...
    public int[] getAIPos(int [][]board,int turn){
        ...
        System.out.println("depth"+AI_SEARCH_DEPTH);
        return Bestmove;
    }
    ...
    public void setDifficulty(int difficulty) {
        switch (difficulty) {
            case 1:
                System.out.println("搜索深度：1，限制步数：10");
                AI_SEARCH_DEPTH = 1;
                AI_LIMITED_MOVE_NUM = 10;
                break;
            case 3:
                System.out.println("搜索深度：3，限制步数：20");
                AI_SEARCH_DEPTH = 3;
                AI_LIMITED_MOVE_NUM = 20;
                break;
            case 6:
                System.out.println("搜索深度：6，限制步数：30");
                AI_SEARCH_DEPTH = 6;
                AI_LIMITED_MOVE_NUM = 30;
                break;
            default:
                System.out.println("默认搜索深度：4，限制步数：20");
                AI_SEARCH_DEPTH = 4;
                AI_LIMITED_MOVE_NUM = 20;
                break;
        }
